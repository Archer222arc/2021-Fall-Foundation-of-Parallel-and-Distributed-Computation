...
# make
# nvcc -v
nvcc --gpu-architecture=sm_50 -std=c++11 -O3 --use_fast_math -Wno-deprecated-gpu-targets -o rb rb_kernel.cu reduce.cu  test.cu  initial_step.cu residual.cu --compiler-bindir /mnt/lustrefs/softwares/gcc/10.1.0/bin/gcc -w
