...
__global__ void initialize(double* du, double* db, const double* u, const double* b, int count);
__global__ void finalize(const double* du, double* u, int count);
__global__ void rb_kernel(double* u, const double* u1, const double* b, double *res, int count);
__global__ void rb_kernel1(double* u, const double* u1, const double* b, double *res, int count);

__global__ void initial_step(double* u, const double* b, double *res);
__global__ void reduce1(const double* res, double *res0);
__global__ void reduce2(const double* res, double *res0);

__global__ void residual(const double* u, const double *u1, const double* b, double *res, int count);
